...
function About() {
    ...
    We, at <div className="bgclip inline-block" htmlFor="companyname">CONTINUUM</div> are solving this problem by implementing blockchain technology which completely removes the trust factor by being completely transparent.
    </div>
    </div>
    <div className={style.featurecardArea}>
        <div className={style.featureCards}>
            <div className='text-2xl mb-5'>Transparent</div>
           
        </div>
        <div className={style.featureCards}>
            <div className='text-2xl mb-5'>Decentralised</div>
            
        </div>
        <div className={style.featureCards}>
            <div className='text-2xl mb-5'>Secure</div>
    ...
    <div className={style.WorkflowWrapper}>
        <div className={`col-start-2 row-start-2 ${style.workwrapperCards}`}>
            ...
            <img className={style.workcardImage} src={wallet} />
    ...
    <div className={style.workCardtext}>
    <img className={style.workcardImage} src={contract} />
    Our technology then creates a time-locked smart contract making the beneficiary 
    the owner at the time of creation of contract, ensuring that no one can interfere
    with the payments received in contract during that time-window.
        </div>
        </div>
        <div className={`col-start-2 row-start-6  ${style.workwrapperCards}`}>
    <div className={style.workCardtext}>
    <img className={style.workcardImage} src={timer} />
    ...
    <div className={style.workCardtext}>
        <img className={style.workcardImage} src={Authentic} />
